/**
 * This file is for the functions that allow live editing of the build bar/available units with the intent of allowing arsenal to be a mechanic
 * 
...
if (model.BuildSet && model.BuildSet.tabsTemplate) {
    model.BuildSet.tabsTemplate = model.BuildSet.tabsTemplate.concat([
        ["bot_factory", "!LOC:factory"],
        ["bot_factory_adv", "!LOC:factory"],
        ["vehicle_factory", "!LOC:factory"],
        ["vehicle_factory_adv", "!LOC:factory"],
        ["air_factory", "!LOC:factory"],
        ["air_factory_adv", "!LOC:factory"],
        ["combat", "!LOC:combat"],
        ["utility", "!LOC:utility"],
        ["air", "!LOC:air"],
        ["arsenal", "!LOC:arsenal"]
