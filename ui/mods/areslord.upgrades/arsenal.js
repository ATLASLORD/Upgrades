...
//hardcoded locks, arsenal packs can add to this by appending to it, units that have been locked will be removed, ensures units stay locked on resets

model.unitsToLock = ["/pa/units/land/tank_nuke_airboom/tank_nuke_airboom.json",
                    "/pa/units/arsenal/unlocked_units/dox_air/dox_air.json",
                    "/pa/units/arsenal/unlocked_units/solar_drone_up/solar_drone_up.json",
                    "/pa/units/arsenal/unlocked_units/bot_bomb_up/bot_bomb_up.json",
                    "/pa/units/arsenal/unlocked_units/assault_bot_adv_up/assault_bot_adv_up.json",
                    "/pa/units/arsenal/unlocked_units/tank_heavy_armor_up/tank_heavy_armor_up.json",
                    "/pa/units/arsenal/unlocked_units/tank_laser_adv_up/tank_laser_adv_up.json",
                    //bugs
                    "/pa/units/land/bug_grunt_big/bug_grunt_big.json",
...
//hardcoded pairs, can be added to by arsenal packs by appending, format is [[arsenalfactoryunit,[unitsToUnlock],[unitToLock],replaceLockedUnitsBool]

//with the addition of replacing units queued I think I will have it be default as the only edge case is arsenal which I will just not track
...
model.unlockPairs = [
    ...
    //tank nuke airboom
    ["/pa/units/arsenal/unlocks/tank_nuke_airboom_unlock/tank_nuke_airboom_unlock.json",//trigger unit
    ["/pa/units/land/tank_nuke_airboom/tank_nuke_airboom.json"],//units added
    ["/pa/units/land/tank_nuke/tank_nuke.json","/pa/units/arsenal/unlocks/tank_nuke_airboom_unlock/tank_nuke_airboom_unlock.json","/pa/units/arsenal/unlocks/tank_nuke_airboom_unlock/arsenal_tank_nuke.json"],//units replaced/locked
    true],//is a replace rather than just locks

    //dox air
    ["/pa/units/arsenal/unlocks/dox_air_unlock/dox_air_unlock.json",
    ["/pa/units/arsenal/unlocked_units/dox_air/dox_air.json"],
    ["/pa/units/land/assault_bot/assault_bot.json","/pa/units/arsenal/unlocks/dox_air_unlock/dox_air_unlock.json","/pa/units/arsenal/unlocks/dox_air_unlock/arsenal_assault_bot.json"],
    true],

    //solar drone up
    ["/pa/units/arsenal/unlocks/solar_drone_up_unlock/solar_drone_up_unlock.json",
    ["/pa/units/arsenal/unlocked_units/solar_drone_up/solar_drone_up.json"],
    ["/pa/units/air/solar_drone/solar_drone.json","/pa/units/arsenal/unlocks/solar_drone_up_unlock/solar_drone_up_unlock.json", "/pa/units/arsenal/unlocks/solar_drone_up_unlock/arsenal_solar_drone.json"],
    true],

    //bot bomb up
    ["/pa/units/arsenal/unlocks/bot_bomb_up_unlock/bot_bomb_up_unlock.json",
    ["/pa/units/arsenal/unlocked_units/bot_bomb_up/bot_bomb_up.json"],
    ["/pa/units/land/bot_bomb/bot_bomb.json","/pa/units/arsenal/unlocks/bot_bomb_up_unlock/bot_bomb_up_unlock.json","/pa/units/arsenal/unlocks/bot_bomb_up_unlock/arsenal_bot_bomb.json"],
     true],

     //assault bot adv up
    ["/pa/units/arsenal/unlocks/assault_bot_adv_up_unlock/assault_bot_adv_up_unlock.json",
    ["/pa/units/arsenal/unlocked_units/assault_bot_adv_up/assault_bot_adv_up.json"],
    ["/pa/units/land/assault_bot_adv/assault_bot_adv.json","/pa/units/arsenal/unlocks/assault_bot_adv_up_unlock/assault_bot_adv_up_unlock.json","/pa/units/arsenal/unlocks/assault_bot_adv_up_unlock/arsenal_assault_bot_adv.json"],
    true],
     
     //tank heavy armor up
    ["/pa/units/arsenal/unlocks/tank_heavy_armor_up_unlock/tank_heavy_armor_up_unlock.json",
    ["/pa/units/arsenal/unlocked_units/tank_heavy_armor_up/tank_heavy_armor_up.json"],
    ["/pa/units/land/tank_heavy_armor/tank_heavy_armor.json","/pa/units/arsenal/unlocks/tank_heavy_armor_up_unlock/tank_heavy_armor_up_unlock.json","/pa/units/arsenal/unlocks/tank_heavy_armor_up_unlock/arsenal_tank_heavy_armor.json"],
    true],

     //tank laser adv up
    ["/pa/units/arsenal/unlocks/tank_laser_adv_up_unlock/tank_laser_adv_up_unlock.json",
    ["/pa/units/arsenal/unlocked_units/tank_laser_adv_up/tank_laser_adv_up.json"],
    ["/pa/units/land/tank_laser_adv/tank_laser_adv.json","/pa/units/arsenal/unlocks/tank_laser_adv_up_unlock/tank_laser_adv_up_unlock.json","/pa/units/arsenal/unlocks/tank_laser_adv_up_unlock/arsenal_tank_laser_adv.json"],
    true],
...
//for circular arsenal the older ones need to be deleted if a newer arsenal is done.
...
// the below is yoinked from scenarios, it is not really needed to be this complex for arsenal
